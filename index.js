...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('qr already scan.subscribe','white'),color('YOU','red'),color('TUBE','white'),color('MR D1CK','yellow'))
})
          ...
          const checkLimit = (sender) => {
           ...
           return false
            ...
            break
                ...
                addKoinUser('13132900007@s.whatsapp.net', fee)
               ...
               if (data.error) return reply(data.error)
				...
				case 'bcgc':
                   ...
                   if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					if (!isRegistered) return reply(ind.noregis())
					client.updatePresence(from, Presence.composing) 
					teks = `\`\`\`Ini adalah list group D1X BOT :\n\n\`\`\``
					no = 0
